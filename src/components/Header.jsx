...
import logo from "./image3.png"; // Adjust the path according to your structure
    ...
    >
      ...
      >
        <a className="block w-[12rem] xl:mr-8" href="#hero">
          <img src={logo} width={190} height={40} alt="StoryNexus" />
        </a>
        <nav
          className={`${
      ...
      lg:bg-transparent`}
        >
         ...
         justify-cente m-auto lg:flex-row"
          >
            {navigation.map((item) => (
              <a
                key={item.id}
